...
const HeadBar = (props) => {
  let mystyle={
    ...
    backgroundColor: props.mode==='dark'?'rgb(51, 47, 47)':'rgb(100, 168, 161)'
  }
...
useEffect(() => {
  ...
  return (
    <div className="headbar" style={mystyle}>
      <div className="headbar__option">
        ...
        <input type="checkbox" className="custom-control-input" id="desc" 
          onChange={(e)=> handleDesc(e.target.checked)}
          role="switch"
          disabled={myState.play ? true : false}/>

        <label className="descLabel" htmlFor="desc">
          Desc
        </label>
      </div>
    </div>
